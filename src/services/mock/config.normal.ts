  ...
  sections: [
      ...
      items: [
        {
          ...
          subtitle: "Book trusted consultations from the comfort of home.",
          ctaLabel: "Book now",
          imageUrl:
            "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1200&q=80",
        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "dental", label: "Dental", icon: "D" },
        { id: "skin", label: "Skin", icon: "S" },
        { id: "heart", label: "Heart", icon: "H" },
        { id: "mental", label: "Mental health", icon: "M" },
      ],
    },
    {
      id: "quick-actions",
      ...
      items: [
        ...
        },
        {
          ...
          subtitle: "Your care in one place",
          icon: "R",
          action: "profile",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          priceInr: 299,
          description: "Speak from anywhere",
        },
      ],
    },
    {
    ...
    },
    {
      id: "offer",
      type: "offer_strip",
      background: { kind: "color", value: "#176B87" },
      items: [
        {
          badge: "FIRST VISIT",
          title: "20% off your first consultation",
          subtitle: "Use code FIRSTCARE when you book today.",

...
const createStyles = (colors: typeof theme.colors) => StyleSheet.create({ container: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: theme.spacing.xl }, circle: { width: 92, height: 92, borderRadius: 46, backgroundColor: colors.success, justifyContent: 'center', alignItems: 'center', marginBottom: 24 }, check: { color: colors.onPrimary, fontSize: 48, fontWeight: '700' }, title: { color: colors.text, fontSize: 25, fontWeight: '800', textAlign: 'center' }, subtitle: { color: colors.text, fontSize: 18, fontWeight: '700', textAlign: 'center', marginTop: 24 }, detail: { color: colors.mutedText, fontSize: 15, textAlign: 'center', marginTop: 6 }, message: { color: colors.mutedText, fontSize: 15, lineHeight: 22, textAlign: 'center', marginTop: 24 }, primary: { minHeight: 50, borderRadius: 25, backgroundColor: colors.primary, minWidth: 220, alignItems: 'center', justifyContent: 'center', marginTop: 28 }, primaryText: { color: colors.onPrimary, fontWeight: '700' }, secondary: { minHeight: 48, justifyContent: 'center', alignItems: 'center', marginTop: 8 }, secondaryText: { color: colors.primary, fontWeight: '700' } });

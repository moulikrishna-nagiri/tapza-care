...
export function HomeHeader({ section, scrollY }: HomeHeaderProps) {
  ...
  return (
    <View style={styles.container} accessibilityRole="header">
      <Animated.View style={[styles.expanded, expandedStyle]}>
        <View>
          ...
          <Animated.Text style={styles.subtitle}>
            {item?.subtitle ?? "How can we help you today?"}
          </Animated.Text>
        </View>
        <Pressable
        ...
        >
          <Animated.Text style={styles.bell}>!</Animated.Text>
        </Pressable>
      </Animated.View>
      <Animated.View
        pointerEvents="none"
      ...
      >
        <Animated.Text style={styles.compactTitle}>Tapza Care</Animated.Text>
        <Animated.Text style={styles.bell}>!</Animated.Text>
      </Animated.View>
    </View>
  );

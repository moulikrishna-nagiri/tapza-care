...
const styles = StyleSheet.create({
  ...
  greeting: { color: theme.colors.text, fontSize: 25, fontWeight: '700' },
  subtitle: { color: theme.colors.mutedText, fontSize: 15, marginTop: 6 },
  compactTitle: { color: theme.colors.text, fontSize: 19, fontWeight: '700' },
  notification: { width: 48, height: 48, borderRadius: 24, backgroundColor: theme.colors.surface, justifyContent: 'center', alignItems: 'center' },
  bell: { color: theme.colors.primary, fontSize: 22, fontWeight: '800' },
});

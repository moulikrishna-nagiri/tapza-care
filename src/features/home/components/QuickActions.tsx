...
const styles = StyleSheet.create({ grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 }, card: { width: '48%', minHeight: 132, borderRadius: 18, backgroundColor: theme.colors.surface, padding: 16, justifyContent: 'space-between' }, pressed: { opacity: 0.75 }, icon: { width: 40, height: 40, borderRadius: 14, backgroundColor: '#E3F3F0', justifyContent: 'center', alignItems: 'center' }, iconText: { color: theme.colors.primary, fontSize: 19, fontWeight: '800' }, title: { color: theme.colors.text, fontSize: 16, fontWeight: '700', marginTop: 12 }, subtitle: { color: theme.colors.mutedText, fontSize: 12, marginTop: 4 } });
